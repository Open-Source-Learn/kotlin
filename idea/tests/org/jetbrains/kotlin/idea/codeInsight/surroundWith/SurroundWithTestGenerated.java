...
@InnerTestClasses({SurroundWithTestGenerated.If.class, SurroundWithTestGenerated.IfElse.class, SurroundWithTestGenerated.Not.class, SurroundWithTestGenerated.As.class, SurroundWithTestGenerated.Parentheses.class, SurroundWithTestGenerated.StringTemplate.class, SurroundWithTestGenerated.When.class, SurroundWithTestGenerated.TryCatch.class, SurroundWithTestGenerated.TryCatchFinally.class, SurroundWithTestGenerated.TryFinally.class, SurroundWithTestGenerated.FunctionLiteral.class})
...
public class SurroundWithTestGenerated extends AbstractSurroundWithTest {
    ...
    @TestMetadata("idea/testData/codeInsight/surroundWith/as")
    @TestDataPath("$PROJECT_ROOT")
    @RunWith(JUnit3RunnerWithInners.class)
    public static class As extends AbstractSurroundWithTest {
        public void testAllFilesPresentInAs() throws Exception {
            JetTestUtils.assertAllTestsPresentByMetadata(this.getClass(), new File("idea/testData/codeInsight/surroundWith/as"), Pattern.compile("^(.+)\\.kt$"), true);
        }

        @TestMetadata("expression.kt")
        public void testExpression() throws Exception {
            String fileName = JetTestUtils.navigationMetadata("idea/testData/codeInsight/surroundWith/as/expression.kt");
            doTestWithAsCastSurrounder(fileName);
        }
    }
